...
[🇬🇧 English Version](README.md) | [🇩🇪 Deutsch Version](README_DE.md)
...
## ⚖️ اطلاعات لایسنس و نسبت‌دهی

این پروژه تحت لایسنس **MIT** منتشر شده است.

اگر از این کد استفاده می‌کنید، **باید** موارد زیر را شامل کنید:
- ✅ نام نویسنده اصلی: **Amirreza Ghanaatiyan**
- ✅ لینک به repository اصلی: [https://github.com/amirrgn/todo-list](https://github.com/amirrgn/todo-list)
- ✅ کپی فایل LICENSE
- ✅ بیان واضح که این کد بر اساس کار Amirreza Ghanaatiyan است

### مثال نسبت‌دهی صحیح:
```
این پروژه بر اساس برنامه To-Do List توسط Amirreza Ghanaatiyan
(https://github.com/amirrgn/todo-list)
تحت لایسنس MIT منتشر شده است
```

### هشدار مهم:
**عدم رعایت شرط نسبت‌دهی (استفاده از این کد بدون اعتبار دادن) می‌تواند منجر به اقدامات قانونی شود.**

برای شرایط کامل لایسنس، فایل [LICENSE](LICENSE) را مطالعه کنید.

---

## 🔗 پیوندها

- [صفحه انگلیسی](README.md)
