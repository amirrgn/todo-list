...
برنامه مدیریت کارهای روزمره به زبان Python با قابلیت ذخیره‌سازی داده‌ها در فایل CSV و Excel. این برنامه با رابط خط فرمان (CLI) کار می‌کند و از اصول برنامه‌نویسی شی‌گرا (OOP) استفاده می‌کند.
...
- ✅ **ذخیره‌سازی CSV**: ذخیره خودکار کارها در فایل CSV
- ✅ **صادرات به Excel**: صادرات کارها به فایل Excel
...
├── tasks.xlsx           # فایل Excel (خودکار ساخته می‌شود)
...
- `export_to_excel()`: صادرات به فایل Excel
